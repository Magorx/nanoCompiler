...
OPDEF(OPCODE_FOR_INFO , 16, "", "", "")
OPDEF(OPCODE_RET      , 17, "ret", "ret ", "ret;")
...
OPDEF(OPCODE_ELEM_PUTN   , 100, "__PUT_NUMBER__", "__PUT_NUMBER__ ", "__PUT_NUMBER__;")
...
OPDEF(OPCODE_ELEM_G_DRAW_TICK , 113, "__G_TICK__", "__G_TICK__ ", "__G_TICK__;")
